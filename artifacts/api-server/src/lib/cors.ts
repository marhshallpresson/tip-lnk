const ALLOWED_ORIGINS = [
  ...
  'https://tipstack.fun',
  'https://www.tipstack.fun',
  'http://localhost:5173',
  'http://localhost:24013',
]

const isAllowedOrigin = (origin: string): boolean => {
  if (ALLOWED_ORIGINS.includes(origin)) return true
  // Allow all Replit dev domains
  if (origin.endsWith('.replit.dev') || origin.endsWith('.janeway.replit.dev') || origin.endsWith('.repl.co')) return true
...
export function applyCors(req: any, res: any): boolean {
  ...
  const cspDirectives = [
    ...
    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://app.dynamic.xyz https://*.dynamic-js.com https://*.dynamic-js.io",
    "font-src 'self' data: https://fonts.gstatic.com https://*.gstatic.com https://*.dynamic.xyz https://*.dynamic-js.com https://*.dynamic-js.io https://*.dynamic-labs.com https://*.dynamicauth.com https://*.dynamic-static-assets.com",
    "img-src 'self' data: https: blob: https://*.dynamic.xyz https://*.dynamic-js.com https://*.dynamic-js.io https://*.dynamic-labs.com https://dynamic-static-assets.com https://*.dynamic-static-assets.com https://*.dynamicauth.com https://tokens.jup.ag https://*.jup.ag",
    ...
    "frame-src 'self' https://app.dynamic.xyz https://*.dynamic.xyz https://*.dynamic-js.com https://*.dynamic-js.io https://*.dynamic-labs.com https://*.dynamicauth.com https://*.dynamic-static-assets.com https://tipstack.fun",
    "object-src 'none'",
    "base-uri 'self'",
    "form-action 'self'",
