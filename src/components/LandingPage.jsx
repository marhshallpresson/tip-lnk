  ...
  return (
    <div className={`flex flex-col ${reversed ? 'md:flex-row-reverse' : 'md:flex-row'} items-center gap-10 md:gap-20 py-16`}>
      <div className="flex-1 space-y-6">
        <div className="w-16 h-16 rounded-2xl bg-[#00d265]/10 flex items-center justify-center border border-[#00d265]/20 mb-6 shadow-[0_0_30px_rgba(0,255,116,0.15)]">
          <Icon size={32} className="text-[#00d265]" />
        </div>
      ...
      <div className="flex-1 w-full relative group">
        <div className="absolute inset-0 bg-gradient-to-r from-[#00d265]/20 to-transparent blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
        <div className="h-[250px] md:h-[300px] w-full rounded-3xl home-card flex items-center justify-center border border-[#00d265]/10 relative z-10 overflow-hidden">
          {/* Abstract visual representation */}
          <div className="absolute inset-0 opacity-20" style={{ backgroundImage: 'linear-gradient(#00d265 1px, transparent 1px), linear-gradient(90deg, #00d265 1px, transparent 1px)', backgroundSize: '20px 20px' }}></div>
          <Icon size={120} className="text-[#00d265]/20" />
        </div>
      </div>
    </div>
  );
...
function ComparisonTable() {
  ...
  return (
    <div className="overflow-x-auto w-full home-card p-4 sm:p-6 border-[#00d265]/20">
      <table className="w-full text-xs md:text-sm">
        <thead>
          <tr className="border-b border-surface-700/50">
            <th className="text-left py-4 px-4 text-[#00d265] font-semibold text-base">Feature</th>
            <th className="text-center py-4 px-4 text-[#00d265] font-black text-lg">TipLnk</th>
        ...
        <tbody>
          {rows.map((row) => (
            <tr key={row.feature} className="border-b border-surface-800/40 hover:bg-surface-900/30 transition-colors">
              ...
              <td className="py-4 px-4 text-center text-[#00d265] font-bold">{row.tiplnk}</td>
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-[#0d1117] text-white">
      ...
      <section className="relative pt-32 md:pt-40 pb-20 px-4 flex flex-col items-center text-center">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_center,rgba(0,255,116,0.15)_0%,transparent_50%)] z-0" />
        ...
        <div className="relative z-10 max-w-[900px] mx-auto w-full">
          ...
          <h1 className="animate-slide-up text-4xl sm:text-5xl md:text-7xl font-black tracking-tight leading-[1.1] mb-8">
            Fund your <span className="whitespace-nowrap">passio<span className="text-[#00d265]">n</span>.</span> <br className="hidden sm:block" />
            Make it <span className="whitespace-nowrap">on-chai<span className="text-[#00d265]">n</span>.</span>
          </h1>
          ...
          <div className="animate-slide-up bg-surface-900/60 backdrop-blur-xl border border-surface-700/50 rounded-2xl p-2 max-w-lg mx-auto flex items-center justify-between shadow-2xl shadow-black/50 mb-6" style={{ animationDelay: '0.2s' }}>
            <div className="flex items-center text-surface-400 pl-4">
              <span className="text-[#00d265]">tiplnk.sol/</span>
            ...
            <button onClick={onGetStarted} className="btn-primary !px-5 py-2 min-h-[20px] ">
              Claim Link
            </button>
          </div>
      ...
      <section id="creators" className="relative z-10 py-16 border-y border-surface-800/60 bg-surface-900/20 px-4">
        <div className="max-w-[1200px] mx-auto overflow-hidden">
          <p className="text-center text-[#00d265] font-bold tracking-widest uppercase text-[10px] sm:text-sm mb-10">Join 10,000+ Creators on TipLnk</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={i} className="home-card p-5 text-center group cursor-pointer border-[#00d265]/10 hover:border-[#00d265]/50 transition-colors">
                ...
                <p className="text-xs text-[#00d265] font-mono mt-1">{c.handle}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="features" className="relative z-10 py-24 px-4">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16 max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-6">Everything you need, <br /><span className="text-[#00d265]">none of the fees.</span></h2>
          </div>
      ...
      <section className="relative z-10 py-32 px-4 text-center">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom,rgba(0,255,116,0.1)_0%,transparent_60%)]" />
        <div className="relative max-w-2xl mx-auto h-full flex flex-col justify-center items-center">
          <div className="w-20 h-20 bg-[#00d265]/10 rounded-full flex items-center justify-center mb-8 border border-[#00d265]/30 shadow-[0_0_30px_rgba(0,255,116,0.3)]">
            <Zap size={40} className="text-[#00d265]" />
          </div>
          <h2 className="text-4xl md:text-6xl font-black text-white mb-8">Start your era.</h2>
          <button onClick={onGetStarted} className="btn-primary text-base !px-10 !py-4 ">
            Claim Your Page
          </button>
        </div>
      </section>
      ...
      <footer className="relative z-10 border-t border-surface-800/40 py-12 px-4 bg-[#0a0d13]">
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-6">
            <a href="/terms" className="text-surface-400 hover:text-[#00d265] transition-colors">Terms & condition</a>
            <a href="/privacy" className="text-surface-400 hover:text-[#00d265] transition-colors">Privacy Policy</a>
            <a href="x.com/useTipLnk" className="text-surface-400 hover:text-[#00d265] transition-colors"><TwitterIcon /></a>
            <a href="https://github.com/marhshallpresson/tip-lnk" className="text-surface-400 hover:text-[#00d265] transition-colors"><GithubIcon /></a>
          </div>
        </div>
      </footer>
    </div>
